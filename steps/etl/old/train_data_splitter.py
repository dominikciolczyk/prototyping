...
def train_data_splitter(
    ...
    sizes = [val_size, test_size] if only_train_val_test_sets else [val_size, test_size, online_size]
    ...
    # Logging summary
    logger.info(
        f"Split fractions: val={val_size}, test={test_size}, online={online_size}, total VM={total_vms}"
    )
